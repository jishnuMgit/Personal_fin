 ...
 <div className="sm:ml-16 flex flex-col space-y-10 p-4 pt-[120px] lg:ml-10 bg-white dark:bg-[#131129] min-h-screen">
     ...
     <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between md:pl-20 lg:mr-20">
            ...
            <div className="flex items-center text-sm text-gray-500 dark:text-gray-300 mt-2 lg:mt-0">
              ...
              <p className="font-medium text-blue-600 dark:text-blue-400"> Budgets</p>
            </div>
          </div>
       
<div>
    <CommonDashboard   budgets={[
    { category: 'Grocery', amount: '$1458.30', icon: '🥕', duration: 'Overtime' },
    { category: 'Cloths', amount: '$1458.30', icon: '👕', duration: 'Week' },
    { category: 'Transportation', amount: '$1458.30', icon: '🚌', duration: 'Month' },
    { category: 'Education', amount: '$1458.30', icon: '🎓', duration: 'Day' },
  ]}
  spendInfo={{
    spend: '$1458.30',
    budget: '$1458.30',
